 ...
 * Main scene manager that handles initialization, object management, and render loop
 */
...
export class Scene {
    ...
    static init(containerId, config = {}) {
        ...
        if (typeof containerId === 'string') {
            finalConfig = { containerId, ...config };
        ...
        Scene.#instance = new Scene(finalConfig);
     ...
     * @returns {Scene|null} Scene instance or null if not initialized
     */
    static getInstance() {
        return Scene.#initialized ? Scene.#instance : null;
    }
    ...
    #initializeScene(config) {
        this.#containerId = config.containerId || 'kalythesainz-container';
